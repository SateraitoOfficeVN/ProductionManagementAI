...
DD-003-SPD — elaborates DD-003, implements BD-003, requirements REQ-028–REQ-039.
...
| 3 | Render the heading and the page actions (items 3, 5, 6) immediately | They never depend on the snapshot, so navigation works in every state, including `error` | — | — |
...
| 3 | 403 | — | — | `forbidden` panel MSG-E021 in place of the widgets; page actions stay |
