...
002_DB — requirements REQ-020–REQ-027 (`work-items/WI-003/brief.md`), basic design 002_BD (`docs/en/010_basic-design/002/002_BD_production-order-list.md`), implements 002_DD and 002_DD-API (`docs/en/020_detailed-design/`, to be written).
