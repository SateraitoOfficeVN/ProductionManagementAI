...
003_DB — requirements REQ-028–REQ-039 (`work-items/WI-004/brief.md`), basic design 003_BD (`docs/en/010_basic-design/003/003_BD_ダッシュボード.md`), implements 003_DD and 003_DD-API (`docs/en/020_detailed-design/`, to be written) and the REQ-033 amendment to 001_DD.
