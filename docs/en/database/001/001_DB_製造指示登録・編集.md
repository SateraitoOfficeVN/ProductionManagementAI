...
Extended by 003_DB (`003_DB_ダッシュボード.md`, WI-004): `production_orders` gains `completed_at_utc` and two check constraints. The table definition below is 001_DB's and is not rewritten; read 003_DB alongside it.
