...
/// <summary>
/// One production order (001_DD module 1). Owns every invariant that needs no I/O: status transitions,
/// the product/quantity lock, and quantity/notes value rules. Date rules need the plant clock and live in
/// the Application service (001_DD-FN).
/// </summary>
public sealed class ProductionOrder
{
    ...
    /// <summary>Generated by PostgreSQL from <see cref="OrderYear"/> and <see cref="OrderSeq"/> (001_DB, DEC-012).</summary>
    ...
    /// <summary>
    /// When the order became <c>Completed</c> (WI-004 REQ-033, 003_DB). Set only by <see cref="Update"/> on the
        ...
        Guid productId, int quantity, DateOnly dueDate, string? notes, ProductionOrderStatus status, DateTimeOffset utcNow)
    {
        ...
        // 001_DD v4 module 1 step 5: the save's own time, in the same save as the status change.
