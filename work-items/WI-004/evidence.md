...
| REQ-033 | Completion time recorded | BD-003 FN-021, FN-022, data design overview (consumer); BD-001 and DB-004 own it | — | — | partly designed — owner documents in steps 4–5 |
...
| 2026-09-22 | BD review | user review of BD-003 | — | not run — awaiting user | — |
