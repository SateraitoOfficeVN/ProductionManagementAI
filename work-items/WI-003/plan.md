...
- Basic design 002_BD (`docs/en/010_basic-design/002/002_BD_製造指示一覧.md`).
- Database design 002_DB (`docs/en/database/002/002_DB_製造指示一覧.md`): indexes for the filters and the default sort, the case-insensitive order-number match, and the demo-order seed (DEC-007). No new table or column is expected; if design finds one is needed, that is a stop condition (see Risks).
