...
The `design` skill for the rendered mockup (step 3.4); it does not imply a UI framework choice — it's a visual preview, not implementation code. Layout-only BD-level work needs no mockup tool.
